...
Exported feature specifications (Markdown). Each file should include front matter linking the Google Doc source and the behavior scenario issue.
...
| [A3-4-dev-high-as-sword-deposit.md](A3-4-dev-high-as-sword-deposit.md) | [A3](https://github.com/lyrasisorghome/InteroperabilityProject/issues/45), [A4](https://github.com/lyrasisorghome/InteroperabilityProject/issues/52) | Dev-high draft v0.4 |
...
Traceability and coverage: [`docs/traceability.md`](../docs/traceability.md).
